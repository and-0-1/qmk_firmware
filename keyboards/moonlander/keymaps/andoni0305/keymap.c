...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MOUSE] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______,  _______,          _______, _______, _______, _______, _______, _______, _______,
        _______, RGB_VAI,   _______, _______, KC_VOLU, DT_UP,  _______,        _______, _______, _______, LGUI(KC_EQL), LGUI(KC_MINUS), KC_MPRV, _______,
        _______, RGB_VAD, KC_MPLY, _______, KC_VOLD, DT_PRNT, _______,           _______, _______, _______, _______, _______, _______, _______,
